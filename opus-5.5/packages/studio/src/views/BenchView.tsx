        ...
        <section className="panel">
          ...
          <div className="panel-body" style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
            ...
            <p className="muted" style={{ margin: 0, fontSize: 12.5, maxWidth: '80ch' }}>
              SQLite is decades-tuned C; OpusDB is {fmtInt(STATS.loc.engine)} lines of TypeScript with no dependencies. Primary-key lookups come out ahead, most likely because every SQLite call crosses the JavaScript/C boundary.
          ...
          <div className="panel-body" style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            <div className="prose" style={{ maxWidth: '84ch' }}>
              <p>
                ...
                caught two bugs in SQLite 3.51.2 itself: <code>NOT IN</code> ignores NULLs when the subquery reads a descending index, and a correlated <code>EXISTS</code> makes{' '}
                <code>LIMIT … OFFSET</code> drop the OFFSET. In those cases SQLite contradicts its own index-free or un-limited answer, and OpusDB matches the consistent one.
              </p>
            </div>
            <div>
